    ...
    <div class="mb-6 flex flex-col md:flex-row md:items-center gap-3" x-data="{ filterOpen: false }">
        ...
        <div class="relative w-full md:w-auto" @click.outside="filterOpen = false">
            <button type="button" @click="filterOpen = !filterOpen"
                ...
                <span>Filter</span>
                <template x-if="$wire.roleFilter !== '' && $wire.roleFilter !== null">
                    <span class="inline-flex items-center justify-center min-w-[18px] h-[18px] px-1 text-[10px] font-bold text-white bg-blue-600 rounded-full">1</span>
                </template>
            </button>
            ...
            <div x-show="filterOpen" x-cloak
                ...
                class="absolute right-0 mt-2 w-72 bg-white dark:bg-gray-800 rounded-lg shadow-lg ring-1 ring-black/5 dark:ring-white/10 z-50 p-4"
                style="display: none;">
                <div class="space-y-3">
                    <div>
