<div wire:key="peralatan-management-index">
    ...
    <x-action-modal
        ...
        type="warning"
        button-color="green"
        title="Setujui Review Peralatan"
        description="Konfirmasi persetujuan review peralatan <strong>{{ $approvingPeralatanName }}</strong>."
    ...
    <x-action-modal
        ...
        type="danger"
        title="Tolak Review Peralatan"
        description="Jelaskan alasan penolakan review peralatan <strong>{{ $rejectingPeralatanName }}</strong>."
        close-method="closeRejectReviewModal"
        show-var="showRejectReviewModal"
        action-method="rejectReview"
        action-text="Tolak Peralatan"
        :textarea="true"
