...
enum ModuleReviewStatus: string
{
    ...
    {
        return match ($this) {
            self::Pending => 'Menunggu Review Modul',
    ...
    {
        return match ($this) {
            self::Pending => 'Modul menunggu review dari tim reviewer',
            self::Approved => 'Modul telah disetujui dan siap digunakan',
            self::Rejected => 'Modul ditolak, perlu revisi sebelum diajukan kembali',
        };
    }
